	...
	<div v-if="loaded">
		...
		<div class="row" style="margin-top: 20px;">
			<div class="col-md-12">
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">Module release properties: </h6>
					</div>
					...
					<div class="card-body">
						<div class="col-md-12">
							<form class="form-horizontal" @submit.prevent="updateModule()">
											...
											<table class="table table-condensed table-striped table-bordered" id="pinsTable">
												...
												<tbody>
													<tr v-for="(pin,ind) in moduleRelease.pins" >
														...
														<td> <button class = "btn btn-danger btn-sm " @click="moduleRelease.pins.splice(ind,1)"> Remove </button> </td>
													</tr>
								...
								<div class="form-row ">
									<div class="col-md-4 offset-md-4 btn-group">
										<button type="submit" class="btn btn-primary mr-2">Update module release</button>
										<button type="button" class="btn btn-primary" @click="$router.go(-1)">Cancel</button>
									</div>
								</div>
							</form>
...
<script src="./ComputationModuleRelease_Edit.js"></script>